...
Opening an  R script creates a new pane to your RStudio, the **Source** pane. In this pane, you can edit and save your code. To run your code, you can hold *Ctrl* and press *Enter*, or click the <kbd>Run</kbd> button. This will run the current line of code, or through your selected lines of code.
